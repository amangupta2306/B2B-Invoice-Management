...
import { ChevronDown, Search, X, ArrowUpDownIcon, PinIcon, MoreHorizontal } from "lucide-react"
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem onClick={() => onOpen("customer", { customer: row })}>
              Edit
            </DropdownMenuItem>
...
const generateColumns = (
  ...
  if (actionDropdown) {
    ...
    const actionColumn: ColumnDef<{ [key: string]: string | number }> = {
      id: 'actions',
      header: () => <span className="w-64 text-gray-800 font-semibold">ACTIONS</span>,
